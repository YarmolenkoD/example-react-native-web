...
const ROOT: ViewStyle = { backgroundColor: '#eee', paddingTop: 10 }
const TITLE: TextStyle = { fontWeight: '600', color: '#3d3d3d' }
const TITLE_WRAPPER: ViewStyle = { paddingHorizontal: 0 }
  ...
  return (
    <View style={ROOT}>
      <View style={HEADER}>
        ...
        {props.code ? <Code style={{ marginTop: 10 }} value={props.code} /> : null}
      </View>
